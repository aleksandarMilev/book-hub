    ...
    <MDBFooter bgColor="light" className="text-center text-lg-start text-muted">
        ...
        <MDBContainer className="text-center text-md-start mt-5">
          <MDBRow className="mt-3">
            <MDBCol md="3" lg="4" xl="3" className="mx-auto mb-4">
              ...
              <p>
                Your one-stop destination for the best books, reviews, and
                recommendations. Join the BookHub community to discover new
                reads and share your favorites!
              </p>
            </MDBCol>
      ...
      <div className="text-center p-4 footer-section">
        ...
        <a
          ...
          href="https://github.com/aleksandarMilev/BookHub"
        >

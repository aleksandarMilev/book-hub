...
export default function ProfileForm({ profile = null, isEditMode = false }) {
  ...
  const validationSchema = Yup.object({
    ...
    imageUrl: Yup.string()
      ...
      .max(
        2000,
        "Image URL length should be between 10 and 2000 characters long"
      )
    ...
    socialMediaUrl: Yup.string()
      ...
      .min(
        10,
        "Social Media URL length should be between 10 and 2000 characters long"
      )
      .max(
        2000,
        "Social Media URL length should be between 10 and 2000 characters long"
    ...
    biography: Yup.string()
      ...
      .max(
        1000,
        "Biography length should be between 10 and 1000 characters long"
      )
      .nullable(),

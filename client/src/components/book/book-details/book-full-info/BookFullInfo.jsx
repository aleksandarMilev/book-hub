...
function ReadingListButtons({
  ...
  const handleRemoveFromList = async () => {
    try {
      ...
      showMessage(
        `You have successfully removed the book from your list!`,
        true
      );
    } catch (error) {
  ...
  return (
    <div className="reading-status">
      ...
      {readingStatus.toLowerCase() ===
        readingListStatus.toRead.toLowerCase() && (
        <p>
          You added this book to <strong>Want to Read</strong>.
        </p>
      )}
      {readingStatus.toLowerCase() ===
        readingListStatus.currentlyReading.toLowerCase() && (
        <p>

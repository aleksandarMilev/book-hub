    ...
    <UserContextProvider>
      <MessageProvider>
        ...
        <Routes>
          ...
          />
          <Route
            path={routes.editProfle}
            element={<ProfileRoute element={<EditProfile />} />}
          />

          <Route
            path={routes.book}
            element={<AuthenticatedRoute element={<BookList />} />}
          />
          <Route
            path={routes.book + "/:id"}
          ...
          <Route
            ...
            element={<ProfileRoute element={<CreateBook />} />}
          />
          <Route
          ...
          <Route
            path={routes.author}
            element={<AuthenticatedRoute element={<AuthorList />} />}
          />
          <Route
          ...
          <Route
            ...
            element={<ProfileRoute element={<CreateAuthor />} />}
          />
          <Route
          ...
          <Route
            path={routes.chats}
            element={<AuthenticatedRoute element={<ChatList />} />}
          />
          <Route
            path={routes.chat + "/:id"}
            element={<ChatRoute element={<ChatDetails />} />}
          />
          <Route
            path={routes.createChat}
            element={<ProfileRoute element={<CreateChat />} />}
          />
          <Route
            path={routes.editChat}
            element={<AuthenticatedRoute element={<EditChat />} />}
          />

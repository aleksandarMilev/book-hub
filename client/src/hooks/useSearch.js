...
export function useBooks(
  ...
  useEffect(() => {
    async function fetchData() {
      try {
        setIsFetching(true);
        const result = await api.searchBooksAsync(
          token,
          searchTerm || "",
          page,
          pageSize
...
export function useChats(
  ...
  useEffect(() => {
    async function fetchData() {
      try {
        setIsFetching(true);
        const result = await api.searchChatsAsync(
          token,
          searchTerm || "",
          page,
          pageSize
...
export function useAuthors(
  ...
  useEffect(() => {
    async function fetchData() {
      try {
        setIsFetching(true);
        const result = await api.searchAuthorsAsync(
          token,
          searchTerm || "",
          page,
          pageSize
...
export function useProfiles(
  ...
  useEffect(() => {
    async function fetchData() {
      try {
        setIsFetching(true);
        const result = await api.searchProfilesAsync(
          token,
          searchTerm || "",
          page,
          pageSize
...
export function useArticles(
  ...
  useEffect(() => {
    async function fetchData() {
      try {
        setIsFetching(true);
        const result = await api.searchArticlesAsync(
          token,
          searchTerm || "",
          page,
          pageSize

export const errors = {
    ...
    author: {
        ...
        create: 'We’re sorry, something went wrong while creating the author. Please try again later. If the issue persists, contact support for assistance.',
    ...
    chat: {
        removeUser: 'Something went wrong while removing this user from the chat. Please try again later.',

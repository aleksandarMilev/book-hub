    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReadingCheckIns", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ReadingCheckIns_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AuthorEdits", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AuthorEdits_Authors_AuthorId",
                        column: x => x.AuthorId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatorId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    IsApproved = table.Column<bool>(type: "bit", nullable: false),
                    AuthorDbModelId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    UserDbModelId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ModifiedOn = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ModifiedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_Books_AspNetUsers_UserDbModelId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookEdits", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BookEdits_Books_BookId",
                        column: x => x.BookId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReadingCheckIns_UserId_Date",
                table: "ReadingCheckIns",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReadingLists_UserId_Status_CompletedOn",
                table: "ReadingLists",
                columns: new[] { "UserId", "Status", "CompletedOn" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Votes_ReviewId_CreatorId",
                table: "Votes",
                columns: new[] { "ReviewId", "CreatorId" },
                unique: true);
        }

namespace BookHub.Tests.Services
{
    ...
    public class AuthorServiceTests
    {
        ...
        [Fact]
        public async Task Names_ShouldReturn_AuthorNames()
        {
            var names = await this.authorService.Names();
        ...
        [Fact]
        public async Task TopThree_ShouldReturn_TopThreeAuthors_ByAverageRating()
        {
            var topAuthors = await this.authorService.TopThree();
        ...
        [Fact]
        public async Task Details_ShouldReturnNull_WhenAuthorDoesNotExist()
        {
            var invalidId = 999_212_214; 

            var author = await this.authorService.Details(invalidId);

            author.Should().BeNull();
        }

        [Fact]
        public async Task AdminDetails_ShouldReturnNull_WhenAuthorDoesNotExist()
        {
            var invalidId = 999_212_214;

            var author = await this.authorService.AdminDetails(invalidId);

            author.Should().BeNull();
        }

        [Fact]
        public async Task Create_ShouldCreateAuthor_AndAlso_SetIsApprovedToFalse_IfCurrentUserIsNotAdmin()
        {
            ...
            var id = await this.authorService.Create(createModel);
        ...
        [Fact]
        public async Task Create_ShouldCreateAuthor_AndAlso_SetIsApprovedToTrue_IfCurrentUserIsAdmin()
        {
        ...
        [Fact]
        public async Task Edit_ShouldEditAuthor_WhenAuthorExists_AndUserIsTheCreator()
        {
            var createModel = new CreateAuthorServiceModel()
            {
                Name = "Bram Stoker",
            ...
            var result = await this.authorService.Edit(id, editModel);
        ...
        [Fact]
        public async Task Edit_ShouldReturnResultWithError_WhenAuthorDoesNotExist()
        {
            var createModel = new CreateAuthorServiceModel()
            {
                Name = "Bram Stoker",
            ...
            _ = await this.authorService.Create(createModel);
            ...
            var result = await this.authorService.Edit(invalidId, editModel);
            result.Succeeded.Should().BeFalse();
            result.ErrorMessage.Should().Be(string.Format(DbEntityNotFound, nameof(Author), invalidId));
        }

        [Fact]
        public async Task Edit_ShouldReturnResultWithError_WhenCurrentUser_IsNotTheAuthorCreator()
        {
            var createModel = new CreateAuthorServiceModel()
            {
                Name = "Bram Stoker",
        ...
        [Fact]
        public async Task Delete_ShouldDeleteAuthor_WhenAuthorExists_AndUserIsTheCreator()
        {
            var createModel = new CreateAuthorServiceModel()
            {
                Name = "Bram Stoker",
            ...
            var result = await this.authorService.Delete(id);
            result.Succeeded.Should().BeTrue();
            result.ErrorMessage.Should().BeNull();
        ...
        [Fact]
        public async Task Delete_ShouldReturnResultWithError_WhenAuthorDoesNotExist()
        {
            var createModel = new CreateAuthorServiceModel()
            {
                Name = "Bram Stoker",
            ...
            var result = await this.authorService.Delete(invalidId);
            result.Succeeded.Should().BeFalse();
            result.ErrorMessage.Should().Be(string.Format(DbEntityNotFound, nameof(Author), invalidId));
        }

        [Fact]
        public async Task Delete_ShouldReturnResultWithError_WhenCurrentUser_IsNotTheAuthorCreator_AndIsNotAdmin()
        {
            var createModel = new CreateAuthorServiceModel()
            {
                Name = "Bram Stoker",
        ...
        [Fact]
        public async Task Delete_ShouldReturnResultWithError_WhenCurrentUser_IsNotTheAuthorCreator_ButIsAdmin()
        {
            this.SetIsAdmin(true);
        ...
        [Fact]
        public async Task Approve_ShouldReturnResultWithError_WhenAuthorDoesNotExist()
        {
            var invalidId = 132_124_142;
            var result = await this.authorService.Approve(invalidId);
            result.Succeeded.Should().BeFalse();
            result.ErrorMessage.Should().Be(string.Format(DbEntityNotFound, nameof(Author), invalidId));
        }

        [Fact]
        public async Task Approve_ShouldReturnResultWithError_WhenCurrentUser_IsNotAdmin()
        {
            var createModel = new CreateAuthorServiceModel()
            {
                Name = "Bram Stoker",
            ...
            var result = await this.authorService.Approve(id);
            result.Succeeded.Should().BeFalse();
            result
                .ErrorMessage
                .Should()
        ...
        [Fact]
        public async Task Approve_ShouldSetIsApprovedToTrue_WhenCurrentUser_IsAdmin_AndAuthorExists()
        {
            this.SetIsAdmin(true);
        ...
        [Fact]
        public async Task Reject_ShouldReturnResultWithError_WhenAuthorDoesNotExist()
        {
            var invalidId = 132_124_142;
            var result = await this.authorService.Reject(invalidId);
            result.Succeeded.Should().BeFalse();
            result.ErrorMessage.Should().Be(string.Format(DbEntityNotFound, nameof(Author), invalidId));
        }

        [Fact]
        public async Task Reject_ShouldReturnResultWithError_WhenCurrentUser_IsNotAdmin()
        {
            var createModel = new CreateAuthorServiceModel()
            {
                Name = "Bram Stoker",
            ...
            var result = await this.authorService.Reject(id);
            result.Succeeded.Should().BeFalse();
            result
                .ErrorMessage
                .Should()
        ...
        [Fact]
        public async Task Reject_ShouldDeleteTheAuthor_WhenCurrentUser_IsAdmin_AndAuthorExists()
        {
            this.SetIsAdmin(true);

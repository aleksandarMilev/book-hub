namespace BookHub.Tests.Services
{
    ...
    public class ChatMessageServiceTests
    {
        ...
        [Fact]
        public async Task Create_ShouldCreateMessage_AndAlso_ShouldReturnServiceModel()
        {
            ...
            var resultServiceModel = await this.chatMessageService.Create(model);
        ...
        [Fact]
        public async Task Edit_ShouldEditTheMessage_AndAlso_ShouldResultWithSuccessAndReturnServiceModel()
        {
            var messageContent = "TESTTESTEST";
            ...
            var createdServiceModel = await this.chatMessageService.Create(createModel);
            ...
            var result = await this.chatMessageService.Edit(createdServiceModel.Id, editModel);
        ...
        [Fact]
        public async Task Edit_ShouldReturnResultWithErrorMessage_IfMessageNotFound()
        {
            var messageContent = "TESTTESTEST";
            ...
            _ = await this.chatMessageService.Create(createModel);
            ...
            var result = await this.chatMessageService.Edit(invalidId, editModel);
            result.Succeeded.Should().BeFalse();
            result.ErrorMessage.Should().Be($"ChatMessage with Id: {invalidId} was not found!");
        }

        [Fact]
        public async Task Edit_ShouldReturnResultWithErrorMessage_IfCurrentUserIsNotMessageCreator()
        {
            var messageContent = "TESTTESTEST";
        ...
        [Fact]
        public async Task Delete_ShouldDeleteTheMessage()
        {
            var messageContent = "TESTTESTEST";
            ...
            var result = await this.chatMessageService.Delete(createdServiceModel.Id);
            result.Succeeded.Should().BeTrue();
            result.ErrorMessage.Should().BeNull();
        ...
        [Fact]
        public async Task Delete_ShouldReturnResultWithErrorMessage_IfMessageNotFound()
        {
            var messageContent = "TESTTESTEST";
            ...
            var invalidId = 421_325_903;
            var result = await this.chatMessageService.Delete(invalidId);
            result.Succeeded.Should().BeFalse();
            result.ErrorMessage.Should().Be($"ChatMessage with Id: {invalidId} was not found!");
        }

        [Fact]
        public async Task Delete_ShouldReturnResultWithErrorMessage_IfCurrentUserIsNotMessageCreator()
        {
            var messageContent = "TESTTESTEST";

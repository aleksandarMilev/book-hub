namespace BookHub.Tests.Services
{
    ...
    public class ReviewServiceTests
    {
        ...
        [Fact]
        public async Task Create_ShouldThrowException_IfUserAlreadyReviewedTheBook()
        {
            var bookId = 1;
            ...
            {
                await this.reviewService.Create(newReviewModel);
            };
        ...
        [Fact]
        public async Task Create_ShouldCreateReview_WhenConditionsAreMet()
        {
            ...
            var id = await this.reviewService.Create(newReviewModel);
        ...
        [Fact]
        public async Task Create_ShouldUpdateBookAndAuthorRating_WhenNewReviewIsAdded()
        {
            var bookId = 2;
            var authorId = 2;
            ...
            await this.reviewService.Create(reviewModel);
        ...
        [Fact]
        public async Task Edit_ShouldReturnErrorMessage_WhenIdIsInvalid()
        {
            foreach (var r in this.data.Reviews)
            {
                if (r.CreatorId == "current-user-id")
            ...
            _ = await this.reviewService.Create(reviewModel);
            ...
            var result = await this.reviewService.Edit(invalidId, updatedReviewModel);
            result.Succeeded.Should().BeFalse();
            result.ErrorMessage.Should().Be($"Review with Id: {invalidId} was not found!");
        }

        [Fact]
        public async Task Edit_ShouldReturnErrorMessage_WhenIdUserIsNotReviewCreator_AndAlso_IsNotAdmin()
        {
            foreach (var r in this.data.Reviews)
            {
                if (r.CreatorId == "current-user-id")
            ...
            var reviewId = await this.reviewService.Create(reviewModel);
            ...
            var result = await this.reviewService.Edit(reviewId, updatedReviewModel);
            result.Succeeded.Should().BeFalse();
            result
                .ErrorMessage
                .Should()
        ...
        [Fact]
        public async Task Edit_ShouldUpdateReview_WhenConditionsAreMet_AndCurrentUserIsTheCreator()
        {
            foreach (var r in this.data.Reviews)
            {
                if (r.CreatorId == "current-user-id")
        ...
        [Fact]
        public async Task Delete_ShouldReturnErrorMessage_WhenIdIsInvalid()
        {
            foreach (var r in this.data.Reviews)
            {
                if (r.CreatorId == "current-user-id")
            ...
            var invalidId = 412_263_892;
            var result = await this.reviewService.Delete(invalidId);
            result.Succeeded.Should().BeFalse();
            result.ErrorMessage.Should().Be($"Review with Id: {invalidId} was not found!");
        }

        [Fact]
        public async Task Delete_ShouldReturnErrorMessage_WhenIdUserIsNotReviewCreator_AndAlso_IsNotAdmin()
        {
            foreach (var r in this.data.Reviews)
            {
                if (r.CreatorId == "current-user-id")
            ...
            var result = await this.reviewService.Delete(reviewId);
            result.Succeeded.Should().BeFalse();
            result
                .ErrorMessage
                .Should()
        ...
        [Fact]
        public async Task Delete_ShouldDeleteReview_WhenConditionsAreMet_AndCurrentUserIsTheCreator()
        {
            foreach (var r in this.data.Reviews)
            {
                if (r.CreatorId == "current-user-id")
        ...
        [Fact]
        public async Task Delete_ShouldReturnErrorMessage_WhenIdUserIsNotReviewCreator_ButIsAdmin()
        {

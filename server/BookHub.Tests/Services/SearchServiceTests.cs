namespace BookHub.Tests.Services
{
    ...
    public class SearchServiceTests
    {
        ...
        [Fact]
        public async Task Books_ShouldReturnAllBooks_WhenSearchTermIsNull()
        {
            var page = 1;
            var pageSize = 10;

            var result = await this.searchService.Books(null, page, pageSize);
        ...
        [Fact]
        public async Task Books_ShouldReturnPaginatedResult()
        {
            var page = 1;
            var pageSize = 2;
        ...
        [Fact]
        public async Task Books_ShouldFilterByTitle()
        {
            var searchTerm = "Pet";
            var page = 1;
            var pageSize = 10;

            var result = await this.searchService.Books(searchTerm, page, pageSize);
        ...
        [Fact]
        public async Task Books_ShouldFilterByIntroduction()
        {
        ...
        [Fact]
        public async Task Books_ShouldFilterByAuthorName()
        {
        ...
        [Fact]
        public async Task Books_ShouldBeCaseInsensitive()
        {
        ...
        [Fact]
        public async Task Books_ShouldReturnEmptyCollection_WhenSearchTermDoesNotMatch()
        {
        ...
        [Fact]
        public async Task Articles_ShouldReturnAllArticles_WhenSearchTermIsNull()
        {
            var page = 1;
            var pageSize = 10;

            var result = await this.searchService.Articles(null, page, pageSize);
        ...
        [Fact]
        public async Task Articles_ShouldReturnPaginatedResult()
        {
            var page = 1;
            var pageSize = 2;
        ...
        [Fact]
        public async Task Articles_ShouldFilterByTitle()
        {
            var searchTerm = "Exploring the Haunting";
            var page = 1;
            var pageSize = 10;

            var result = await this.searchService.Articles(searchTerm, page, pageSize);
        ...
        [Fact]
        public async Task Articles_ShouldFilterByIntroduction()
        {
        ...
        [Fact]
        public async Task Articles_ShouldBeCaseInsensitive()
        {
            var searchTerm = "EXPloRinG tHE HauNTinG";
            var page = 1;
            var pageSize = 10;
        ...
        [Fact]
        public async Task Articles_ShouldReturnEmptyCollection_WhenSearchTermDoesNotMatch()
        {
            var searchTerm = "invalid search term";
            var page = 1;
            var pageSize = 10;
        ...
        [Fact]
        public async Task Authors_ShouldReturnAllAuthors_WhenSearchTermIsNull()
        {
            var page = 1;
            var pageSize = 10;

            var result = await this.searchService.Authors(null, page, pageSize);
        ...
        [Fact]
        public async Task Authors_ShouldReturnPaginatedResult()
        {
            var page = 1;
            var pageSize = 2;
        ...
        [Fact]
        public async Task Authors_ShouldFilterByName()
        {
            var searchTerm = "Steph";
            var page = 1;
            var pageSize = 10;

            var result = await this.searchService.Authors(searchTerm, page, pageSize);
        ...
        [Fact]
        public async Task Authors_ShouldFilterByPenName()
        {
            var searchTerm = "Bach";
            var page = 1;
            var pageSize = 10;
        ...
        [Fact]
        public async Task Authors_ShouldBeCaseInsensitive()
        {
        ...
        [Fact]
        public async Task Authors_ShouldReturnEmptyCollection_WhenSearchTermDoesNotMatch()
        {
            var searchTerm = "invalid search term";
            var page = 1;
            var pageSize = 10;
        ...
        [Fact]
        public async Task Profiles_ShouldReturnAllProfiles_WhenSearchTermIsNull()
        {
            var page = 1;
            var pageSize = 10;

            var result = await this.searchService.Profiles(null, page, pageSize);
        ...
        [Fact]
        public async Task Profiles_ShouldReturnPaginatedResult()
        {
            var page = 1;
            var pageSize = 2;
        ...
        [Fact]
        public async Task Profiles_ShouldFilterByFristName()
        {
            var searchTerm = "John";
            var page = 1;
            var pageSize = 10;

            var result = await this.searchService.Profiles(searchTerm, page, pageSize);
        ...
        [Fact]
        public async Task Profiles_ShouldFilterByLastName()
        {
            var searchTerm = "Doe";
            var page = 1;
            var pageSize = 10;
        ...
        [Fact]
        public async Task Profiles_ShouldFilter_ConcatenatedFirstAndLastName()
        {
        ...
        [Fact]
        public async Task Profiles_ShouldBeCaseInsensitive()
        {
        ...
        [Fact]
        public async Task Profiles_ShouldReturnEmptyCollection_WhenSearchTermDoesNotMatch()
        {
            var searchTerm = "invalid search term";
            var page = 1;
            var pageSize = 10;
        ...
        [Fact]
        public async Task Chats_ShouldReturnAllChats_WhereCurrentUserIsParticipant_AndAlso_HasAcceptedToJoin_WhenSearchTermIsNull()
        {
            ...
            var result = await this.searchService.Chats(null, page, pageSize);
        ...
        [Fact]
        public async Task Chats_ShouldReturnPaginatedResult()
        {
            this.SetCurrentUserId("user1Id");
        ...
        [Fact]
        public async Task Chats_ShouldFilterByName()
        {
            this.SetCurrentUserId("user1Id");
            ...
            var result = await this.searchService.Chats(searchTerm, page, pageSize);
        ...
        [Fact]
        public async Task Chats_ShouldBeCaseInsensitive()
        {
            this.SetCurrentUserId("user1Id");
        ...
        [Fact]
        public async Task Chats_ShouldReturnEmptyCollection_WhenSearchTermDoesNotMatch()
        {
            var searchTerm = "invalid search term";
            var page = 1;
            var pageSize = 10;

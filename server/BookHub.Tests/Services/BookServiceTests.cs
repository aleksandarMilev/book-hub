namespace BookHub.Tests.Services
{
    ...
    public class BookServiceTests 
    {
        ...
        [Fact]
        public async Task TopThree_ShouldReturn_ThreeBooksOrderedByRating()
        {
            var topBooks = await this.bookService.TopThree();
        ...
        [Fact]
        public async Task ByGenre_ShouldReturn_PaginatedBooksOrderedByRating()
        {
            int genreId = 7;
            int page = 1;
            int pageSize = 2;

            var paginatedResult = await this.bookService.ByGenre(genreId, page, pageSize);
        ...
        [Fact]
        public async Task ByAuthor_ShouldReturn_PaginatedBooksOrderedByRating()
        {
            int authorId = 1;
            int page = 1;
            int pageSize = 2;

            var paginatedResult = await this.bookService.ByAuthor(authorId, page, pageSize);
        ...
        [Fact]
        public async Task Details_ShouldReturn_BookDetailsServiceModel_WhenBookExists()
        {
            var bookId = 1;

            var result = await this.bookService.Details(bookId);
        ...
        [Fact]
        public async Task Details_ShouldReturn_Null_WhenBookExistsAndIsNotApproved()
        {
            var bookId = 1;
        ...
        [Fact]
        public async Task Details_ShouldReturn_Null_WhenBookDoesNotExist()
        {
            var bookId = 999;
        ...
        [Fact]
        public async Task AdminDetails_ShouldReturn_BookDetailsServiceModel_WhenBookExists()
        {
            var bookId = 1;

            var result = await this.bookService.AdminDetails(bookId);
        ...
        [Fact]
        public async Task AdminDetails_ShouldReturn_BookDetailsServiceModel_WhenBookExists_AndItIsNotApproved()
        {
            var bookId = 1;
        ...
        [Fact]
        public async Task AdminDetails_ShouldReturn_Null_WhenBookDoesNotExist()
        {
            var bookId = 999;
        ...
        [Fact]
        public async Task Create_ShouldReturnBookId_AndSetIsApprovedToFalse_IfUserIsRegularUser()
        {
            ...
            var bookId = await this.bookService.Create(model);
        ...
        [Fact]
        public async Task Create_ShouldReturnBookId_AndSetIsApprovedToFalse_IfUserIsAdmin()
        {
        ...
        [Fact]
        public async Task Edit_ShouldReturn_Success_WhenBookIsEditedSuccessfully()
        {
            ...
            var bookId = await this.bookService.Create(createModel);
            ...
            var result = await this.bookService.Edit(bookId, editModel);
        ...
        [Fact]
        public async Task Edit_ShouldReturn_Error_WhenBookNotFound()
        {
            var editModel = new CreateBookServiceModel()
            {
                AuthorId = 1,
            ...
            var result = await this.bookService.Edit(invalidId, editModel);
        ...
        [Fact]
        public async Task Edit_ShouldReturn_Error_WhenUserIsNotTheCreator()
        {
            var createModel = new CreateBookServiceModel()
            {
                Title = "The Dead Zone",
        ...
        [Fact]
        public async Task Delete_ShouldReturn_Success_WhenBookIsDeletedSuccessfully()
        {
            var createModel = new CreateBookServiceModel()
            {
                Title = "The Dead Zone",
            ...
            var bookId = await this.bookService.Create(createModel);
            var result = await this.bookService.Delete(bookId);
        ...
        [Fact]
        public async Task Delete_ShouldReturn_Error_WhenBookNotFound()
        {
            var invalidId = 213_422_580;
            var result = await this.bookService.Delete(invalidId);
        ...
        [Fact]
        public async Task Delete_ShouldReturn_Error_WhenUserIsNotCreatorOrAdmin()
        {
            this.SetIsAdmin(false);
        ...
        [Fact]
        public async Task Delete_ShouldReturn_Error_WhenUserIsNotCreatorButIsAdmin()
        {
            this.SetIsAdmin(true);
        ...
        [Fact]
        public async Task Approve_ShouldApproveBook()
        {
            this.SetIsAdmin(false);
            ...
            var result = await this.bookService.Approve(bookId);
        ...
        [Fact]
        public async Task Approve_ShouldReturnError_IfBookNotFound()
        {
            this.SetIsAdmin(false);
            ...
            var result = await this.bookService.Approve(invalidId);
        ...
        [Fact]
        public async Task Reject_ShouldDeleteTheBook()
        {
            this.SetIsAdmin(false);
            ...
            var result = await this.bookService.Reject(bookId);
        ...
        [Fact]
        public async Task Reject_ShouldReturnError_IfBookNotFound()
        {
            this.SetIsAdmin(false);
            ...
            var invalidId = 211_244_858;
            var result = await this.bookService.Reject(invalidId);

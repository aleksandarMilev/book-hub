namespace BookHub.Server.Tests.Services
{
    ...
    public class ArticleServiceTests
    {
        ...
        [Fact]
        public async Task DetailsAsync_ShouldReturnNull_IfArticleWithThisIdDoesNotExists()
        {
            var invalidId = 123_124_214;
            var article = await this.articleService.DetailsAsync(invalidId);
            article.Should().BeNull();
        }

        [Fact]
        public async Task DetailsAsync_ShouldReturnTheCorrectArticle_IfIdIsValid_AndAlso_ShouldIncrementViewCount()
        {
            var id = 1;
            ...
            var anotherRequest = await this.articleService.DetailsAsync(id);

            (anotherRequest!.Views - prevViewCount).Should().Be(1);
        }

        [Fact]
        public async Task CreateAsync_ShouldCreateArticle_AndReturnId()
        {
            ...
            var id = await this.articleService.CreateAsync(model);
        ...
        [Fact]
        public async Task EditAsync_ShouldReturnResultWithError_IfIdIsNotValid()
        {
            ...
            _ = await this.articleService.CreateAsync(createModel);
            ...
            var result = await this.articleService.EditAsync(invalidId, editModel);
        ...
        [Fact]
        public async Task EditAsync_ShouldReturnResultWithError_IfCurrentUserIsNotAdmin()
        {
            var createModel = new CreateArticleServiceModel()
            {
                Title = "TestTestTest",
            ...
            var id = await this.articleService.CreateAsync(createModel);
            ...
            var result = await this.articleService.EditAsync(id, editModel);
            result.Succeeded.Should().BeFalse();
            result
                .ErrorMessage
                .Should()
        ...
        [Fact]
        public async Task EditAsync_ShouldEditTheArticle_AndReturnResultWithSuccess_IfCurrentUserIsAdmin()
        {
        ...
        [Fact]
        public async Task DeleteAsync_ShouldReturnResultWithError_IfIdIsNotValid()
        {
            var invalidId = 143_239_849;
            var result = await this.articleService.DeleteAsync(invalidId);
            result.Succeeded.Should().BeFalse();
            result
                .ErrorMessage
                .Should()
        ...
        [Fact]
        public async Task Async_ShouldReturnResultWithError_IfCurrentUserIsNotAdmin()
        {
            var model = new CreateArticleServiceModel()
            {
                Title = "TestTestTest",
            ...
            var result = await this.articleService.DeleteAsync(id);
            result.Succeeded.Should().BeFalse();
            result
                .ErrorMessage
                .Should()
        ...
        [Fact]
        public async Task DeleteAsync_ShouldDeleteTheArticle_AndReturnResultWithSuccess_IfCurrentUserIsAdmin()
        {
            this.SetIsAdmin(true);

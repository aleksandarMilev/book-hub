namespace BookHub.Server.Tests.Services
{
    ...
    public class ProfileServiceTests
    {
        ...
        [Fact]
        public async Task HasProfileAsync_ShouldReturnTrue_WhenUserHasProfile()
        {
            var userId = "user1Id";
            this.SetCurrentUserId(userId);

            var result = await this.profileService.HasProfileAsync();
            result.Should().BeTrue();
        }

        [Fact]
        public async Task HasProfileAsync_ShouldReturnFalse_WhenUserDoesNotHaveProfile()
        {
            var userId = "user6Id";
            this.SetCurrentUserId(userId);
        ...
        [Fact]
        public async Task HasProfileAsync_ShouldReturnFalse_WhenUserDoesNotExist()
        {
        ...
        [Fact]
        public async Task MoreThanFiveCurrentlyReadingAsync_ShouldReturnTrue_WhenCurrentlyReadingBooksCountIsFive()
        {
            var userId = "user4Id";
            this.SetCurrentUserId(userId);

            var result = await this.profileService.MoreThanFiveCurrentlyReadingAsync(userId);
            result.Should().BeTrue();
        }

        [Fact]
        public async Task MoreThanFiveCurrentlyReadingAsync_ShouldReturnFalse_WhenCurrentlyReadingBooksCountIsLessThanFive()
        {
            var userId = "user1Id";
            this.SetCurrentUserId(userId);
        ...
        [Fact]
        public async Task MoreThanFiveCurrentlyReadingAsync_ShouldReturnFalse_WhenUserDoesNotExist()
        {
            var invalidId = "invalid-id";
            this.SetCurrentUserId(invalidId);

            var result = await this.profileService.MoreThanFiveCurrentlyReadingAsync(invalidId);
            result.Should().BeFalse();
        }

        [Fact]
        public async Task TopThreeAsync_ShouldReturnTopThreeProfiles_ByActivityScore()
        {
            ...
            var actualProfiles = (await this.profileService.TopThreeAsync()).ToList();
        ...
        [Fact]
        public async Task MineAsync_ShouldReturnProfile_WhenCurrentUserHasProfile()
        {
            var userId = "user1Id";
            this.SetCurrentUserId(userId);

            var result = await this.profileService.MineAsync();
        ...
        [Fact]
        public async Task MineAsync_ShouldReturnNull_WhenCurrentUserDoesNotHaveProfile()
        {
            var userId = "user6Id";
            this.SetCurrentUserId(userId);
        ...
        [Fact]
        public async Task MineAsync_ShouldReturnNull_WhenCurrentUserDoesNotExist()
        {
            var userId = "invalidId";
            this.SetCurrentUserId(userId);
        ...
        [Fact]
        public async Task OtherUserAsync_ShouldReturnProfile_WhenUserExistsAndProfileIsPublic()
        {
            var userId = "user1Id";
            this.SetCurrentUserId(userId);

            var result = await this.profileService.OtherUserAsync(userId);
            result.Should().NotBeNull();
        ...
        [Fact]
        public async Task OtherUserAsync_ShouldReturnPrivateProfileModel_WhenUserExistsAndProfileIsPrivate()
        {
            var userId = "user4Id";
            this.SetCurrentUserId(userId);
        ...
        [Fact]
        public async Task OtherUserAsync_ShouldReturnNull_WhenUserDoesNotExist()
        {
            var userId = "invalidId";
            this.SetCurrentUserId(userId);
        ...
        [Fact]
        public async Task CreateAsync_ShouldCreateProfile_WhenModelIsValid()
        {
            ...
            var result = await this.profileService.CreateAsync(createProfileModel);
        ...
        [Fact]
        public async Task EditAsync_ShouldReturnErrorMessage_WhenProfileNotFound()
        {
            ...
            _ = await this.profileService.CreateAsync(createProfileModel);
            ...
            var result = await this.profileService.EditAsync(editProfileModel);
            result.Succeeded.Should().BeFalse();
            result.ErrorMessage.Should().Be($"UserProfile with Id: {invalidId} was not found!");
        }

        [Fact]
        public async Task EditAsync_ShouldEditProfile_WhenProfileExists()
        {
        ...
        public async Task DeleteAsync_ShouldReturnTrue_WhenProfileExists()
        {
            ...
            var id = await this.profileService.CreateAsync(createProfileModel);

            var result = await this.profileService.DeleteAsync();
            result.Succeeded.Should().BeTrue();
            result.ErrorMessage.Should().BeNull();
        ...
        [Fact]
        public async Task DeleteAsync_ShouldReturnErrorMessage_WhenProfileDoesNotExist()
        {
            var createProfileModel = new CreateProfileServiceModel()
            {
                FirstName = "Test",
        ...
        [Fact]
        public async Task UpdateCountAsync_ShouldUpdateProfileCount_WhenValidUserIdAndPropertyName()
        {
            var userId = "user1Id"; 
            ...
            await this.profileService.UpdateCountAsync(userId, propertyName, count => count + 1);
        ...
        [Fact]
        public async Task UpdateCountAsync_ShouldThrowDbEntityNotFoundException_WhenUserNotFound()
        {
            var invalidId = "invalid-id";
            this.SetCurrentUserId(invalidId);
            ...
            {
                await this.profileService.UpdateCountAsync(invalidId, propertyName, x => ++x);
            };
        ...
        [Fact]
        public async Task UpdateCountAsync_ShouldThrowArgumentException_WhenInvalidPropertyName()
        {
            var id = "user2Id";
            ...
            var updateCountAsync = async () =>
            {
                await this.profileService.UpdateCountAsync(id, propertyName, x => ++x);
            };
        ...
        [Fact]
        public async Task UpdateCountAsync_ShouldNotChangeOtherProperties()
        {
            var userId = "user2Id";
            ...
            await this.profileService.UpdateCountAsync(userId, propertyName, x => ++x);

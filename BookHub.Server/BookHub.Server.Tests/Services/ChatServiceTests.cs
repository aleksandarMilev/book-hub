namespace BookHub.Server.Tests.Services
{
    ...
    public class ChatServiceTests
    {
        ...
        [Fact]
        public async Task NotJoinedAsync_ShouldReturnCollectionFromServiceModels_WhereUserHasNotJoined()
        {
            var userToJoinId = "user3Id";

            var result = await this.chatService.NotJoinedAsync(userToJoinId);
        ...
        [Fact]
        public async Task NotJoinedAsync_ShouldNotReturn_ChatsWhereUserJoined()
        {
            var userToJoinId = "user3Id";
        ...
        [Fact]
        public async Task CanAccessChatAsync_ShouldReturn_True_WhenTheUserIsMemberOfTheChat()
        {
            var chatId = 1;
            var userId = "user1Id"; 

            var result = await this.chatService.CanAccessChatAsync(chatId, userId);
            result.Should().BeTrue();
        }

        [Fact]
        public async Task CanAccessChatAsync_ShouldReturnFalse_WhenTheUserIsNotMemberOfTheChat()
        {
            var chatId = 1;
        ...
        [Fact]
        public async Task CanAccessChatAsync_ShouldReturnFalse_WhenChatDoesNotExist()
        {
            var invalidChatId = 214_325_945; 
            var userId = "user1Id"; 

            var result = await this.chatService.CanAccessChatAsync(invalidChatId, userId);
            result.Should().BeFalse();
        }

        [Fact]
        public async Task CanAccessChatAsync_ShouldReturn_False_WhenUserDoesNotExist()
        {
            var chatId = 1; 
        ...
        [Fact]
        public async Task IsInvitedAsync_ShouldReturnTrue_WhenUserIsInvitedButHasNotAccepted()
        {
            var chatId = 1; 
            var userId = "user3Id"; 

            var result = await this.chatService.IsInvitedAsync(chatId, userId);
            result.Should().BeTrue();
        }

        [Fact]
        public async Task IsInvitedAsync_ShouldReturnFalse_WhenUserIsNotInvited()
        {
            var chatId = 2;
            var userId = "current-user-id";
        ...
        [Fact]
        public async Task IsInvitedAsync_ShouldReturn_FalseWhenUserHasAlreadyAcceptedInvitation()
        {
            var chatId = 1; 
            var userId = "user2Id"; 
        ...
        [Fact]
        public async Task IsInvitedAsync_ShouldReturn_False_WhenChatDoesNotExist()
        {
            var invalidChatId = 214_325_945;
            var userId = "user3Id";

            var result = await this.chatService.IsInvitedAsync(invalidChatId, userId);
            result.Should().BeFalse();
        }

        [Fact]
        public async Task IsInvitedAsync_ShouldReturn_False_WhenUserDoesNotExist()
        {
            var chatId = 1; 
            var userId = "invalid-user-id"; 
        ...
        [Fact]
        public async Task DetailsAsync_ShouldReturnChatDetailsServiceModel_WhenChatExists()
        {
            var chatId = 1;

            var result = await this.chatService.DetailsAsync(chatId);
            result.Should().NotBeNull();
        ...
        [Fact]
        public async Task DetailsAsync_ShouldReturnNull_WhenChatDoesNotExist()
        {
            var invalidChatId = 214_325_945;

            var result = await this.chatService.DetailsAsync(invalidChatId);
            result.Should().BeNull();
        }

        [Fact]
        public async Task CreateAsync_ShouldCreateChat_WithValidData()
        {
            ...
            var createdChatId = await this.chatService.CreateAsync(chatModel);
        ...
        [Fact]
        public async Task CreateAsync_ShouldUseDefaultImageUrl_WhenImageUrlIsNull()
        {
            var createModel = new CreateChatServiceModel() { Name = "Chat 5" };

            var createdChatId = await this.chatService.CreateAsync(createModel);
        ...
        [Fact]
        public async Task CreateAsync_ShouldAddCreatorAsParticipant()
        {
        ...
        [Fact]
        public async Task EditAsync_ShouldUpdateChat_AndAlso_ReturnResultWithSuccess_WhenCalledByCreator()
        {
            var createModel = new CreateChatServiceModel() { Name = "Chat 5" };
            var id = await this.chatService.CreateAsync(createModel);
            ...
            var result = await this.chatService.EditAsync(id, editModel);
        ...
        [Fact]
        public async Task EditAsync_ShouldUseDefaultImage_WhenImageUrlIsNotProvided()
        {
            var createModel = new CreateChatServiceModel() { Name = "Chat 5" };
            var id = await this.chatService.CreateAsync(createModel);
            ...
            _ = await this.chatService.EditAsync(id, editModel);
        ...
        [Fact]
        public async Task EditAsync_ShouldReturnResultWithErrorMessage_WhenChatDoesNotExists()
        {
            var createModel = new CreateChatServiceModel() { Name = "Chat 5" };
            _ = await this.chatService.CreateAsync(createModel);
            ...
            var result = await this.chatService.EditAsync(invalidId, editModel);
            result.Succeeded.Should().BeFalse();
            result.ErrorMessage.Should().Be($"Chat with Id: {invalidId} was not found!");
        }

        [Fact]
        public async Task EditAsync_ShouldReturnResultWithErrorMessage_WhenCalledByNonCreator()
        {
            var createModel = new CreateChatServiceModel() { Name = "Chat 5" };
            var id = await this.chatService.CreateAsync(createModel);
        ...
        [Fact]
        public async Task DeleteAsync_ShouldDeleteChat_WhenCalledByCreator()
        {
            var createModel = new CreateChatServiceModel() { Name = "Chat 5" };
            var id = await this.chatService.CreateAsync(createModel);

            var result = await this.chatService.DeleteAsync(id);
        ...
        [Fact]
        public async Task DeleteAsync_ShouldDeleteChat_WhenCalledByAdmin()
        {
            var createModel = new CreateChatServiceModel() { Name = "Chat 5" };
            var id = await this.chatService.CreateAsync(createModel);
        ...
        [Fact]
        public async Task DeleteAsync_ShouldReturnNotFound_WhenChatDoesNotExist()
        {
            var createModel = new CreateChatServiceModel() { Name = "Chat 5" };
            _ = await this.chatService.CreateAsync(createModel);

            var invalidId = 412_341_532;
            var result = await this.chatService.DeleteAsync(invalidId);
        ...
        [Fact]
        public async Task DeleteAsync_ShouldReturnResultWithErrorMessage_WhenCalledByNonCreatorAndNonAdmin()
        {
            var createModel = new CreateChatServiceModel() { Name = "Chat 5" };
            var id = await this.chatService.CreateAsync(createModel);
        ...
        [Fact]
        public async Task InviteUserToChatAsync_ShouldCreateMapEntity()
        {
            var createModel = new CreateChatServiceModel() { Name = "Chat 5" };
            var chatId = await this.chatService.CreateAsync(createModel);

            var userId = "fake-id";

            var result = await this.chatService.InviteUserToChatAsync(chatId, createModel.Name, userId);
            result.Succeeded.Should().BeTrue();
            result.ErrorMessage.Should().BeNull();
        ...
        [Fact]
        public async Task InviteUserToChatAsync_ShouldReturnResultWithError_IfCurrentUserIsNotTheChatCreator()
        {
            var createModel = new CreateChatServiceModel() { Name = "Chat 5" };
            var chatId = await this.chatService.CreateAsync(createModel);
        ...
        [Fact]
        public async Task AcceptAsync_ShouldReturnPrivateProfileServiceModel_AndAlso_ShouldSetHasAcceptedToTrueInTheMapEntity()
        {
            ...
            await this.chatService.InviteUserToChatAsync(chatId, createModel.Name, userToInviteId);

            this.SetCurrentUserId(userToInviteId);

            var result = await this.chatService.AcceptAsync(chatId, createModel.Name, creatorId);
            result.Succeeded.Should().BeTrue();
        ...
        [Fact]
        public async Task AcceptAsync_ShouldReturnResultWithErrorMessage_IfMapEntityNotFound()
        {
            var creatorId = "current-user-id";
        ...
        [Fact]
        public async Task RejectAsync_ShouldReturnResultWithSuccess_AndAlso_ShouldDeleteTheMapEntity()
        {
            var creatorId = "current-user-id";
            ...
            var result = await this.chatService.RejectAsync(chatId, createModel.Name, creatorId);
            result.Succeeded.Should().BeTrue();
            result.ErrorMessage.Should().BeNull();
        ...
        [Fact]
        public async Task RejectAsync_ShouldReturnResultWithErrorMessage_IfMapEntityNotFound()
        {
            var creatorId = "current-user-id";
        ...
        [Fact]
        public async Task RemoveUserAsync_ShouldReturnResultWithSuccess_AndAlso_ShouldDeleteTheMapEntity_IfCurrentUserIsTheChatCreator()
        {
            var creatorId = "current-user-id";
            ...
            this.SetCurrentUserId(userToInviteId);
            _ = await this.chatService.AcceptAsync(chatId, createModel.Name, creatorId);

            this.SetCurrentUserId(creatorId);
            var result = await this.chatService.RemoveUserAsync(chatId, userToInviteId);
            result.Succeeded.Should().BeTrue();
            result.ErrorMessage.Should().BeNull();
        ...
        [Fact]
        public async Task RemoveUserAsync_ShouldReturnResultWithSuccess_AndAlso_ShouldDeleteTheMapEntity_IfCurrentUserWantsToLeaveTheChat()
        {
            var creatorId = "current-user-id";
        ...
        [Fact]
        public async Task RemoveUserAsync_ShouldReturnResultWithErrorMessage_IfCurrentUserIsNotTheChatCreator_AndAlso_IsNotCurrentUserIsNoTryingToLeaveTheChat()
        {
            var creatorId = "current-user-id";
